...
function HesSingleGallery(index) {
  ...
  this.options.wrapAround =
    typeof gallery.dataset.wrap == "undefined"
      ? HesGallery.options.wrapAround
      : gallery.dataset.wrap == "true";
  this.options.showImageCount =
    typeof gallery.dataset.imgCount == "undefined"
      ? HesGallery.options.showImageCount
  ...
  [].forEach.call(
    ...
    function(image, i) {
      if (image.dataset.disabled == "true") disabledCount++;
        ...
        image.setAttribute(
          "onclick",
          "HesGallery.show(" + this.index + "," + (i - disabledCount) + ")"
        );
      }
    }.bind(this)
  );
...
HesGallery.init = function() {
  if (!this.executed) {
    ...
    this.EOM.galery.innerHTML +=
      "<div id='hg-bg' onclick='HesGallery.hide()'></div>";
    this.EOM.galery.innerHTML +=
      "<div id='hg-pic-cont'><img id='hg-pic' /></div>";

    this.EOM.galery.innerHTML +=
      "<button id='hg-prev' onclick='HesGallery.prev()'></button>";
    this.EOM.galery.innerHTML +=
      "<button id='hg-next' onclick='HesGallery.next()'></button>";
    ...
    this.EOM.pic_cont.innerHTML +=
      "<div id='hg-prev-onpic' onclick='HesGallery.prev()'></div>";
    this.EOM.pic_cont.innerHTML +=
      "<div id='hg-next-onpic' onclick='HesGallery.next()'></div>";
...
HesGallery.show = function(g, i) {
  ...
  if (this.options.animations || this.EOM.pic_cont.classList == "hg-transition")
    this.EOM.pic_cont.classList.remove("hg-transition");

  document
    .getElementById("hg-pic")
    .setAttribute("src", this.galleries[g].imgPaths[i]); // ustawia ścieżke do zdjęcia
  ...
  if (
    ...
    this.EOM.pic_cont.dataset.howmany =
  ...
  if (this.options.disableScrolling)
    document.body.classList += " hg-disable-scrolling"; // Wyłącza scrollowanie
};
...
HesGallery.hide = function() {
  ...
  this.open = false;
  if (this.options.disableScrolling)
    document.body.classList.remove("hg-disable-scrolling"); // Włącza scrollowanie
};
